...
public class CarDriver : MonoBehaviour {
    ...
    private void Awake()
    {
        ...
        if (stats == null)
        {
            ...
            idleSlowdown = 10f;
            turnSpeedMax = 300f;
            turnSpeedAcceleration = 300f;
            turnIdleSlowdown = 500f;
        }
    }
    ...
    private void Update() {
        if (stats != null)
        {
            ...
            idleSlowdown = stats.idleSlowdown;
            turnSpeedMax = stats.turnSpeedMax;
            turnSpeedAcceleration = stats.turnSpeedAcceleration;
            turnIdleSlowdown = stats.turnIdleSlowdown;
    ...
    private void OnCollisionEnter(Collision collision) {
        if (collision.gameObject.layer == ColliderLayer) {
